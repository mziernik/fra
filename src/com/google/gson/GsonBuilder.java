 ...
 * methods, and finally calling create.</p>
 *
 * <p>
 ...
 * <li> The default serialization of {@link Date} and its subclasses in Gson
 * does not contain time-zone information. So, if you are using date/time
 * instances, use {@code GsonBuilder} and its {@code setDateFormat}
 * methods.</li>
 * </ul>
 * </p>
 *
...
public final class GsonBuilder {
     ...
     * null null null null     {@link java.lang.reflect.Modifier#TRANSIENT},
   * {@link java.lang.reflect.Modifier#STATIC}.
     ...
     * deserialize some {@code Point} class, which contains an x and y
     * coordinate, to/from the JSON Primitive string value {@code "(x,y)"}. The
     * Java map would then be serialized as a {@link JsonObject}.
     *
     * <p>
     * Below is an example:
     * <pre>  {@code
     ...
     *   TConsole.print(gson.toJson(original, type));
     * }</pre> The above code prints this JSON object:
     * <pre>  {@code
     *   {
     *     "(5,6)": "a",
     *     "(8,8)": "b"
     ...
     * applied. In this case, some {@code new Point(2,3)} would serialize as {@code
     * {"x":2,"y":5}}.
     *
     * <p>
     ...
     *
     * @param fieldNamingStrategy the actual naming strategy to apply to the
     * fields
     * @return a reference to this {@code GsonBuilder} object to fulfill the
     * "Builder" pattern
     * @since 1.3
     ...
     * combines the registration of an
     * {@link TypeAdapter}, {@link InstanceCreator}, {@link JsonSerializer}, and
     * a {@link JsonDeserializer}. It is best used when a single object
     ...
     *
     * @param baseType the class definition for the type adapter being
     * registered for the base class or interface
     ...
     * it outputs strictly compliant JSON. Hence, if it encounters a float value {@link Float#NaN},
     * {@link Float#POSITIVE_INFINITY}, {@link Float#NEGATIVE_INFINITY}, or a
     * double value
     * {@link Double#NaN}, {@link Double#POSITIVE_INFINITY}, {@link Double#NEGATIVE_INFINITY},
     * it will throw an {@link IllegalArgumentException}. This method provides a

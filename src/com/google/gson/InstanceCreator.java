 ...
 * a (public or private) no-args constructor as follows:</p>
 *
 * <pre>
 * private Id() {
 ...
 * {@code InstanceCreator} for {@code Id}:</p>
 *
 * <pre>
 ...
 * Json. You should also ensure that a
 * <i>new</i> object is returned, not a common object since its fields will be
 * overwritten. The developer will need to register {@code IdInstanceCreator}
 * with Gson as follows:</p>
 *
 * <pre>

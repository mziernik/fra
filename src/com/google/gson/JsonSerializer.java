 ...
 * <
 * pre>
 * public class Id&lt;T&gt; { private final Class&lt;T&gt; clazz; private final
 * long value;
 *
 * public Id(Class&lt;T&gt; clazz, long value) { this.clazz = clazz; this.value
 * = value; }
 *
 ...
 * achieve that by writing a custom serializer:</p>
 *
 * <p>
 * <
 * pre>
 * class IdSerializer implements JsonSerializer&lt;Id&gt;() { public JsonElement
 * serialize(Id id, Type typeOfId, JsonSerializationContext context) { return
 * new JsonPrimitive(id.getValue()); } }
 * </pre></p>
 *
 * <p>
 * You will also need to register {@code IdSerializer} with Gson as follows:</p>
 * <pre>
 ...
 * that a serializer may be asked to serialize a specific generic type of the T.
 */

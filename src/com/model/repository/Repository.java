...
public class Repository<PRIMARY_KEY> {
    ...
    public class RepoConfig {
        ...
        public Runnable1<RecordCallback> createCallback;
        public Runnable1<RecordCallback> editCallback;
        public Runnable1<RecordCallback> validateCallback;
        ...
        private Params buildParams() {
            ...
            String callbacks = (createCallback != null ? "C" : "")
                    + (editCallback != null ? "E" : "")
                    + (validateCallback != null ? "V" : "");
            ...
            return new Params()
                    ...
                    .escape("callbacks", callbacks.isEmpty() ? null : callbacks);
        }
    ...
    /**
     * Przepisuje dane z Record do DAOQuery
     *
     * @param qry
     * @param rec
     * @param parent
     * @return
     */
    protected DAOQuery fillQuery(DAOQuery qry, Record rec, Record parent) {
        ...
        switch (qry.crude) {
            ...
            case UPDATE:
                ...
                for (Column<?> col : columns.values()) {
                    ...
                    if (parent != null
                            && col instanceof IForeignColumn
                            && (value == null || Objects.equals(value, -1) || Objects.equals(value, ""))) {
                        Column<?> fCol = ((IForeignColumn<?>) col).getForeignColumn();

                        if (fCol.repository == parent.repo)
                            value = parent.get(fCol.getKey());
                    }
    ...
    public static void loadAll(DAO<?> dao) throws Exception {
        ...
        for (Repository<?> repo : ALL.values()) {
            ...
            queries.add(repo.fillQuery(new DAOQuery(repo, dao, CRUDE.READ), null, null));
        }
    ...
    public Column<?> getColumnF(String key) {
        Column<?> column = getColumn(key);
        if (column == null)
            throw new RepositoryException(this, "Nie znaleziono kolumny " + Utils.escape(key));
        return column;
    }

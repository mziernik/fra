package com.servers.websocket.drafts;
...
import com.servers.websocket.WebSocket.Role;
...
import com.servers.websocket.exceptions.LimitExedeedException;
import com.servers.websocket.framing.CloseFrame;
import com.servers.websocket.framing.FrameBuilder;
import com.servers.websocket.framing.Framedata;
import com.servers.websocket.framing.Framedata.Opcode;
import com.servers.websocket.framing.FramedataImpl1;
import com.servers.websocket.handshake.ClientHandshake;
import com.servers.websocket.handshake.ClientHandshakeBuilder;
import com.servers.websocket.handshake.HandshakeBuilder;
import com.servers.websocket.handshake.HandshakeImpl1Client;
import com.servers.websocket.handshake.HandshakeImpl1Server;
...
public abstract class Draft {
    ...
    public List<Framedata> continuousFrame(Opcode op, ByteBuffer buffer, boolean fin) {
        ...
        try {
            ...
            throw new ThrowableException(e); // can only happen when one builds close frames(Opcode.Close)
        }
        bui.setFin(fin);
        if (fin)

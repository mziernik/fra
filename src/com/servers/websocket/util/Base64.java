package com.servers.websocket.util;
...
public class Base64 {
    ...
    public static String encodeObject(java.io.Serializable serializableObject, int options)
        ...
        if (serializableObject == null)
            throw new NullPointerException("Cannot serialize a null object.");   // end if: null
    ...
    public static byte[] encodeBytesToBytes(byte[] source, int off, int len, int options) throws java.io.IOException {
        ...
        if (source == null)
            throw new NullPointerException("Cannot serialize a null array.");   // end if: null

        if (off < 0)
            throw new IllegalArgumentException("Cannot have negative offset: " + off);   // end if: off < 0

        if (len < 0)
            throw new IllegalArgumentException("Cannot have length offset: " + len);   // end if: len < 0

        if (off + len > source.length)
            throw new IllegalArgumentException(
                    String.format("Cannot have offset of %d and length of %d with array of length %d", off, len, source.length));   // end if: off < 0
    ...
    private static int decode4to3(
        ...
        if (source == null)
            throw new NullPointerException("Source array was null.");   // end if
        if (destination == null)
            throw new NullPointerException("Destination array was null.");   // end if
        if (srcOffset < 0 || srcOffset + 3 >= source.length)
            throw new IllegalArgumentException(String.format(
                    "Source array with length %d cannot have offset of %d and still process four bytes.", source.length, srcOffset));   // end if
...
//        }
    ...
    public static byte[] decode(byte[] source, int off, int len, int options)
        ...
        // Lots of error checking and exception throwing
        if (source == null)
            throw new NullPointerException("Cannot decode null source array.");   // end if
        if (off < 0 || off + len > source.length)
            throw new IllegalArgumentException(String.format(
                    "Source array with length %d cannot have offset of %d and process %d bytes.", source.length, off, len));   // end if

        if (len == 0)
            return new byte[0];
        else if (len < 4)
            throw new IllegalArgumentException(
                    "Base64-encoded string must have at least four characters, but length specified was " + len);   // end if
        ...
        for (i = off; i < off + len; i++) {  // Loop through source
            ...
            if (sbiDecode >= WHITE_SPACE_ENC) {
                ...
                throw new java.io.IOException(String.format(
                        "Bad Base64 input character decimal %d in array position %d", ((int) source[i]) & 0xFF, i));   // end else: 
    ...
    public static byte[] decode(String s, int options) throws java.io.IOException {
        ...
        if (s == null)
            throw new NullPointerException("Input string was null.");   // end if
            ...
            if (java.util.zip.GZIPInputStream.GZIP_MAGIC == head) {
                ...
                try {
                    ...
                    while ((length = gzis.read(buffer)) >= 0)
                        baos.write(buffer, 0, length);   // end while: reading input
    ...
    public static Object decodeToObject(
        ...
        try {
            ...
            if (loader == null)
                ois = new java.io.ObjectInputStream(bais);   // end if: no loader provided
                ...
                ois = new java.io.ObjectInputStream(bais) {
                    ...
                    public Class<?> resolveClass(java.io.ObjectStreamClass streamClass)
                        ...
                        if (c == null)
                            ...
                            return c; // Class loader knows of this class.   // end else: not null
                    }   // end resolveClass
                }; // end ois   // end else: no custom class loader
    ...
    public static void encodeToFile(byte[] dataToEncode, String filename)
        ...
        if (dataToEncode == null)
            throw new NullPointerException("Data to encode was null.");   // end iff
    ...
    public static byte[] decodeFromFile(String filename)
        ...
        try {
            ...
            if (file.length() > Integer.MAX_VALUE)
                throw new java.io.IOException("File is too big for this convenience method (" + file.length() + " bytes).");   // end if: file too big for int index
    ...
    public static class InputStream extends java.io.FilterInputStream {
        ...
        public int read() throws java.io.IOException {
                ...
                if (encode) {
                    ...
                    for (int i = 0; i < 3; i++) {
                        ...
                        if (b >= 0) {
                            ...
                            break; // out of for loop   // end else: end of stream
                    ...
                    if (numBinaryBytes > 0) {
                        ...
                        return -1; // Must be end of stream   // end else
                } // end if: encoding
                // Else decoding
                else {
                    byte[] b4 = new byte[4];
                    ...
                    for (i = 0; i < 4; i++) {
                        ...
                        if (b < 0)
                            break; // Reads a -1 if end of stream   // end if: end of stream
                    ...
                    if (i == 4) {
                        ...
                        return -1;   // end else if: also padded correctly
                    else
            ...
            // Else error
                ...
                throw new java.io.IOException("Error in Base64 code reading stream.");   // end else
        }   // end read
        ...
        public int read(byte[] dest, int off, int len)
            ...
            for (i = 0; i < len; i++) {
                ...
                if (b >= 0)
                    ...
                    break; // Out of 'for' loop // Out of 'for' loop
    ...
    public static class OutputStream extends java.io.FilterOutputStream {
        ...
        public void write(int theByte)
            ...
            if (decodabet[theByte & 0x7f] > WHITE_SPACE_ENC) {
                ...
                throw new java.io.IOException("Invalid character in Base64 data."); // end else: not white space either   // end else: decoding
        }   // end write
        ...
        public void write(byte[] theBytes, int off, int len)
            ...
            for (int i = 0; i < len; i++)
                write(theBytes[off + i]);   // end for: each byte written
        ...
        public void flushBase64() throws java.io.IOException {
            if (position > 0)
                if (encode) {
                    ...
                    throw new java.io.IOException("Base64 input not properly padded."); // end else: decoding   // end if: buffer partially full

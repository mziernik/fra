...
import com.servers.websocket.drafts.Draft.CloseHandshakeType;
import com.servers.websocket.drafts.Draft.HandshakeState;
import com.servers.websocket.drafts.Draft_10;
import com.servers.websocket.drafts.Draft_17;
import com.servers.websocket.drafts.Draft_75;
import com.servers.websocket.drafts.Draft_76;
import com.servers.websocket.exceptions.IncompleteHandshakeException;
import com.servers.websocket.exceptions.InvalidDataException;
import com.servers.websocket.exceptions.InvalidHandshakeException;
import com.servers.websocket.exceptions.WebsocketNotConnectedException;
import com.servers.websocket.framing.CloseFrame;
import com.servers.websocket.framing.CloseFrameBuilder;
import com.servers.websocket.framing.Framedata;
import com.servers.websocket.framing.Framedata.Opcode;
import com.servers.websocket.handshake.ClientHandshake;
import com.servers.websocket.handshake.ClientHandshakeBuilder;
import com.servers.websocket.handshake.Handshakedata;
import com.servers.websocket.handshake.ServerHandshake;
import com.servers.websocket.handshake.ServerHandshakeBuilder;
import com.servers.websocket.server.WebSocketServer.WebSocketWorker;
...
public class WebSocketImpl implements WebSocket {
    ...
    public void decode(ByteBuffer socketBuffer) {
        ...
        if (DEBUG)
            TConsole.print("process(" + socketBuffer.remaining() + "): {" + (socketBuffer.remaining() > 1000
                    ? "too big to display"
    ...
    private void decodeFrames(ByteBuffer socketBuffer) {
        ...
        try {
            ...
            for (Framedata f : frames) {
                if (DEBUG)
                    TConsole.print("matched frame: " + f);
    ...
    public void sendFrame(Framedata framedata) {
        if (DEBUG)
            TConsole.print("send frame: " + framedata);
    ...
    public void startHandshake(ClientHandshakeBuilder handshakedata) throws InvalidHandshakeException {
        ...
        // Send
        // TConsole.print(new String( draft.createHandshake(this.handshakerequest, role).get(0).array()));
        write(draft.createHandshake(this.handshakerequest, role));
    }

    private void write(ByteBuffer buf) {
        if (DEBUG)
            TConsole.print("write(" + buf.remaining() + "): {" + (buf.remaining() > 1000
    ...
    private void open(Handshakedata d) {
        if (DEBUG)
            TConsole.print("open using draft: " + draft.getClass().getSimpleName());

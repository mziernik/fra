...
public class MPFileReader implements Iterable<Part> {
    ...
    public MPFileReader(File file, String signature) throws IOException {
        ...
        try {
            ...
            if (v < 0 || v > 255)
                throw new IOException(LIo.INVALID_FILE_SIGNATURE.toString());
            ...
            v = in.read();
            if (v != 1)
                throw new IOException(LIo.INVALID_FILE_VERSION.toString());

            int flags = in.read();

            int totalSize = readInt(in);
            if (totalSize > size)
                throw new IOException(LIo.INVALID_FILE_SIZE.toString());
            ...
            if (partsCount < 0 || partsCount > 255)
                throw new IOException(LIo.INVALID_PART_COUNT.toString());
            ...
            for (int i = 0; i < partsCount; i++) {
                ...
                if ((f & 0x02) > 0) {
                    ...
                    in.read(buff);
                    part.name = new String(buff, Utils.UTF8);
                }
    ...
    public class Part {
        ...
        public InputStream getInputStream() throws IOException {
            if (encrypted) {
                ...
                if (cryptKey == null)
                    throw new IOException(LIo.MISSING_KEY.toString());
                ...
                if (passHash != null)
                    try {
                        ...
                        if (!Arrays.equals(buff, passHash))
                            throw new IOException(LIo.INVALID_KEY.toString());
        ...
        public class MPFInputStream extends InputStream {
            ...
            public void close() throws IOException {
                ...
                if (!Arrays.equals(md5, bmd5))
                    throw new IOException(LIo.INVALID_CHECKSUM.toString());

...
public class MPFileWriter {
    ...
    private final IOBuffer builder;
    public boolean saveMD5 = true;
    public boolean encrypted = false;
    public Date date = new Date();

    public MPFileWriter() throws IOException {
        builder = new IOBuffer(null);
    }

    public Part add(Integer type, String name) throws IOException {
        Part part = new Part();
        parts.add(part);
        part.name = name;
        part.type = type;
    ...
    public IOBuffer build() throws IOException {
        ...
        try {
            ...
            TOutputStream header = new TOutputStream(true);
    ...
    public class Part extends TOutputStream {
        ...
        public void flush() throws IOException {
            ...
            if (cipherOut != null && cipherOut.enabled && !flushed) {
                ...
                cipherPadding = cipherPadding % 16 != 0
                        ? 16 - cipherPadding % 16 : 0;

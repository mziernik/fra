...
public class AllocationRecorder {
    ...
    private static final LinkedHashMap<Class<?>, Long> classSizesMap
   ...
   * @param sampler  The sampler to add.
     ...
     * @param instr the instrumentation object to use for finding the object
     * size
     ...
     *
     * @param count the count of how many instances are being allocated, if an
     * array is being allocated. If an array is not being allocated, then this
     * value will be -1.

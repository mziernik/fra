 ...
 * {@link org.objectweb.asm.ClassWriter}, and verifies properties of the class
 * getting written.
 *
...
public class VerifyingClassAdapter extends ClassVisitor {
     ...
     * {@inheritDoc}
     *
     * In addition, the returned {@link org.objectweb.asm.MethodVisitor} will
     * throw an exception if the method is greater than 64K in length.
     */
    @Override
